"""
Django settings for rilca project.
...
SECRET_KEY = '+le6k@73%$s(a$(zyaggfye#5f&t8r38yem*88&0rn0)zf-(98'
...
WSGI_APPLICATION = 'rilca.wsgi.application'
...
DOCUMENT_FOLDER = os.path.join(os.path.abspath("."), "PADocument")
